...
const LongRosaryPaginated = () => {
	 ...
	 // State to control visibility of specific mysteries (each with a unique index)
	  ...
	  const elements = [
		...
		<div className="rosary-prayer">
		  <h2>This is an experimental feature. This is the start of the Rosary. Click on the plus button to go to the next page, click on the minus button to go to the previous page. Try swiping left and right as well.</h2>
		</div>
		</>
		,
	<>
          ...
          {visibleMysteries.includes(1) && (
            <div>
              ...
              <p>
                ...
                me. 'He advanced a little and fell prostrate in prayer, saying,
                'My Father, if it is possible, let this cup pass from me; yet,
          ...
          {visibleMysteries.includes(2) && (
            <div>
              ...
              <p>
                ...
                not find the body of the Lord Jesus. While they were puzzling
                over this, behold, two men in dazzling garments appeared to
                them. They were terrified and bowed their faces to the ground.
                They said to them, 'Why do you seek the living one among the
                dead? He is not here, but he has been raised.'” - Luke 24:1-5{" "}
              </p>
          ...
          {visibleMysteries.includes(3) && (
            <div>
              ...
              <p>
                ...
                from the heavens, saying, 'This is my beloved Son, with whom I
          ...
          {visibleMysteries.includes(5) && (
            <div>
              ...
              <p>
                ...
                scourged, he handed him over to be crucified.” - Matthew 27:26{" "}
              </p>
          ...
          {visibleMysteries.includes(6) && (
            <div>
              ...
              <p>
                ...
                into heaven and took his seat at the right hand of God.” - Mark
                16:19{" "}
              </p>
          ...
          {visibleMysteries.includes(8) && (
            <div>
              ...
              <p>
                ...
                when Quirinius was governor of Syria. So all went to be
                enrolled, each to his own town. And Joseph too went up from
                Galilee from the town of Nazareth to Judea, to the city of David
                that is called Bethlehem, because he was of the house and family
                of David, to be enrolled with Mary, his betrothed, who was with
                child. While they were there, the time came for her to have her
                child, and she gave birth to her firstborn son. She wrapped him
          ...
          {visibleMysteries.includes(9) && (
            <div>
              ...
              <p>
                ...
                stripped off his clothes and threw a scarlet military cloak
                about him. Weaving a crown out of thorns, they placed it on his
                head, and a reed in his right hand. And kneeling before him,
                they mocked him, saying, 'Hail, King of the Jews!'” - Matthew
                27:27-29
              </p>
          ...
          {visibleMysteries.includes(10) && (
            <div>
              ...
              <p>
                ...
                which parted and came to rest on each one of them. And they were
        ...
        <div className="rosary-prayer">
          ...
          {visibleMysteries.includes(12) && (
            <div>
              ...
              <p>
                ...
                Jerusalem to present him to the Lord, just as it is written in
                the law of the Lord, 'Every male that opens the womb shall be
                consecrated to the Lord,' and to offer the sacrifice of 'a pair
                of turtledoves or two young pigeons,' in accordance with the
                dictate in the law of the Lord.” - Luke 2:21-24{" "}
              </p>
          ...
          {visibleMysteries.includes(13) && (
            <div>
              ...
              <p>
                ...
                Rufus, to carry his cross. They brought him to the place of
                Golgotha (which is translated Place of the Skull).” - Mark
                15:21-22{" "}
              </p>
          ...
          {visibleMysteries.includes(14) && (
            <div>
              ...
              <p>
                {" "}
                "Behold, from now on will all ages call me blessed. The Mighty
                One has done great things for me, and holy is his name.” - Luke
                1:48-49
              </p>
          ...
          {visibleMysteries.includes(15) && (
            <div>
              ...
              <p>
                ...
                clothes became white as light.” - Matthew 17:1-2{" "}
              </p>
          ...
          {visibleMysteries.includes(16) && (
            <div>
              ...
              <p>
                ...
                in the caravan, they journeyed for a day and looked for him
                among their relatives and acquaintances, but not finding him,
                they returned to Jerusalem to look for him. After three days
          ...
          {visibleMysteries.includes(17) && (
            <div>
              ...
              <p>
                ...
                what they do.'] They divided his garments by casting lots. The
                people stood by and watched; the rulers, meanwhile, sneered at
                him and said, 'He saved others, let him save himself if he is
                the chosen one, the Messiah of God.' Even the soldiers jeered at
                him. As they approached to offer him wine they called out, 'If
                you are King of the Jews, save yourself.' Above him there was an
                inscription that read, 'This is the King of the Jews.' Now one
                of the criminals hanging there reviled Jesus, saying, 'Are you
                not the Messiah? Save yourself and us.' The other, however,
                rebuking him, said in reply, 'Have you no fear of God, for you
                are subject to the same condemnation? And indeed, we have been
                condemned justly, for the sentence we received corresponds to
                our crimes, but this man has done nothing criminal.' Then he
                said, 'Jesus, remember me when you come into your kingdom.' He
                replied to him, 'Amen, I say to you, today you will be with me
                in Paradise.'"It was now about noon and darkness came over the
	...
	<>
		<div className="rosary-prayer">
          ...
          <p>
            ...
            to thee, O Virgin of virgins, my Mother; to thee do I come; before
	...
	<>
	<div className="rosary-prayer">
		  <h2>This is an experimental feature. This is the end of the Rosary.</h2>
	</div>
	</>
	...
	return (
		<>
      <div className="long-rosary-container" {...handlers}>
		{elements[page]}
      ...
      >
		...
		<p style={{marginLeft: "2rem", fontSize: "3rem"}}>
			-
		</p>
		</span>
		<span onClick={nextPage}>
        <p style={{marginRight: "2rem", fontSize: "3rem"}}>
          +
        </p>
		</span>
      </div>
...
export default LongRosaryPaginated;