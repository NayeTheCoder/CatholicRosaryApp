  ...
  return (
    ...
    <div className="Divine-Mercy-images-containerSpanish">
      ...
      <Prayer title="Oración de Apertura">
            ...
            para las almas y el mar de misericordia se abrió para el
            mundo entero. Oh fuente de vida, insondable
            Misericordia Divina, abarca al mundo entero y
            derrámate sobre nosotros
      </Prayer>
    <Prayer title="">
            Oh Sangre y Agua que brotaste del Corazón de
            Jesús, como una Fuente de Misericordia para nosotros (3 veces)
        </Prayer>
